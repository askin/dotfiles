...
(defvar dv-modeline-bg '("#3e4745" "#181818"))
...
(custom-theme-set-faces
 ...
 `(font-lock-keyword-face ((t (:foreground ,(dv-color dv-keyword-fg) :bold t))))
 ...
 `(hl-line ((t (:bold t :background ,(dv-color dv-lazy-hl-bg)))))
